...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        //条状的颜色
        self.barTintColor = [UIColor colorWithRed:218/255.0 green:176/255.0 blue:116/255.0 alpha:1.0];
        ...
        self.commitBar.tintColor = [UIColor whiteColor];
        [self.commitBar setTitleTextAttributes:@{NSFontAttributeName : [UIFont systemFontOfSize:15],
        ...
        self.cancelBar.tintColor = [UIColor whiteColor];
        [self.cancelBar setTitleTextAttributes:@{NSFontAttributeName : [UIFont systemFontOfSize:15],
                                                 NSForegroundColorAttributeName : [UIColor whiteColor]} forState:UIControlStateNormal];
