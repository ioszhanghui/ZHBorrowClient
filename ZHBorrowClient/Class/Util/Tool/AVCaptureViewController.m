...
-(void)viewWillDisappear:(BOOL)animated {
    ...
    [self.navigationController.navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName:UIColorWithRGB(0x323232,1.0)}];
...
-(void)showAuthorizationDenied {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        // 更新界面
        [AlertViewTool showAlertWithTitle:@"提示" message:@"请在“设置-一键借钱-相机”选项中，允许访问您的相机" clickAtIndex:^(UIAlertView *alertView, NSInteger buttonIndex) {
            if (buttonIndex==1) {
