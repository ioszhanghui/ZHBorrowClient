...
@interface ZHPickerView() <UIPickerViewDelegate,UIPickerViewDataSource,UIGestureRecognizerDelegate>
...
const int pickerViewHeight = 220;
...
+ (ZHPickerView *)showPickerViewAddedTo :(UIView *)view dataArray: (NSArray *)array
    ...
    ZHPickerView * myPickerView = [[ZHPickerView alloc]initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height)];
