    ...
    [geocoder reverseGeocodeLocation:currentLocation completionHandler:^(NSArray *placemarks,NSError *error)
     {
         if (placemarks.count > 0) {
             ...
             //详细地址
             _lastAddress = test[@"FormattedAddressLines"][0];
             ...
             if ([pro containsString:@"北京"]
                 ...
                 _lastAddress= [pro stringByAppendingString:[NSString stringWithFormat:@" %@",city]];
             }else{
                 _lastAddress= [city stringByAppendingString:[NSString stringWithFormat:@",%@",pro]];
             }
